...
Telegram-бот для управления приватным VPN-сервисом. Автоматизируйте приём оплаты, выдачу ключей и напоминания о продлении. 
Бот работает с несколькими серверами и имеет удобный пользовательский интерфейс.
